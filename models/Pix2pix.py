...
class ResNet(nn.Module):
    def __init__(self, input_nc, output_nc, ngf, n_blocks, output, norm_layer, use_dropout=False, out_clamp=None):
...
# TODO : Implementation
class Pix2pix:
    def __init__(self, generator, discriminator, recon_loss, mse_loss):
